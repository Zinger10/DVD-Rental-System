...
<html>
<head>
<title>dvdlisting_improved</title>
...
$result = $connection->query("SELECT *, GROUP_CONCAT(CONCAT(' ',a.fname,' ',a.lname) 
									ORDER BY a.fname) AS Name 
									FROM dvdtitles t JOIN dvdactorstitles at
									ON t.asin = at.asin
									JOIN dvdactors a
